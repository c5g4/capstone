...
// Start - By Jeremy 2024-06-02
resource "aws_eks_access_entry" "lcheong" {
  cluster_name      = aws_eks_cluster.eks.name
  principal_arn     = "arn:aws:iam::255945442255:user/lcheong"
  type              = "STANDARD"
}

resource "aws_eks_access_policy_association" "lcheong" {
  cluster_name      = aws_eks_cluster.eks.name
  principal_arn     = "arn:aws:iam::255945442255:user/lcheong"
